...
fun main() {
    ...
    for (i in listOfFishes) {
        when(i){
            ...
            Fishes19_1.SIAMESEFIGHTINGFISH.id-> fishName19_1(Fishes19_1.SIAMESEFIGHTINGFISH)
        }
    }
}
...
fun fishName19_1(fishName:Fishes19_1){
    when(fishName){
        ...
        Fishes19_1.SIAMESEFIGHTINGFISH->println("Вы можете поместить в свой аквариум рыбу петушок")
    }
}